...
# Define the Langevine MC optimization algorithm using a functional API
...
# Define the custom optimizer class LangevinMC, inheriting from Optimizer
class LangevinMC(Optimizer):
    ...
    def init_map(self):
        # Initialize the mapping between parameters and their positions in the noise vector
        self.mapping = dict()
        index = 0
    ...
    def step(self):
        ...
        for group in self.param_groups:
            ...
            # Call the Langevine MC functional API to update parameters
